...
import java.util.Map;
	...
	public class SalleDAttenteAvecPrioBN <TC extends AvecPrio> extends HashMap<Integer,ArrayList<TC>> implements SalleDAttente<TC>{
		...
		public SalleDAttenteAvecPrioBN(int taille, int Prio) {
			capaciteMax = taille;
			maxPrio = Prio;
		...
		public static void main(String[] args) {
			SalleDAttenteAvecPrioBN s = new SalleDAttenteAvecPrioBN(15, 5);
